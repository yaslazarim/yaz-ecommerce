...
const products: Product[] = [
  {
    ...
    characteristics:"Fio Premium • Ponto Fechado • Acabamento delicado • Alça de ombro confortável.",
  ...
  },
  {
    ...
    description: "Bolsa artesanal em tons vibrantes de coral, ideal para os dias quentes. Com textura exclusiva de crochê e acabamento resistente, combina praticidade e estilo, sendo perfeita para passeios, praias ou encontros descontraídos com um toque de cor.",
    characteristics:"Fio Náutico resistente • Ideal para o verão • Textura exclusiva • Fácil de limpar.",
    material: "Nautico 100% Poliéster",
    dimensions: "35cm x 28cm x 12cm",
    weight: "800g",
  ...
  },
  {
    ...
    characteristics:"Design Estruturado • Fio de Malha Leve • Acabamento impecável • Alça ajustável.",
    material: "Barbante 100% algodão",
    dimensions: "35cm x 28cm x 12cm",
    weight: "800g",
  ...
  },
  {
    ...
    characteristics:"Mini Bag • Fio Firme e resistente • Alça Transversal (Corrente/Couro) • Fecho magnético.",
    material: "Barbante 100% algodão",
  ...
  },
  {
    ...
    characteristics:"Estilo Bucket • Ponto Relevo de textura • Base e forro reforçados • Fechamento por cordão.",
    material: "Barbante 100% algodão",
  ...
  },
  {
    ...
    characteristics:"Maxi Bag • Fio Grosso Estruturado • Amplo espaço interno • Crochê artesanal refinado.",
    material: "Barbante 100% algodão",
