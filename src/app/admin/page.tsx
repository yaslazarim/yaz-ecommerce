        ...
        <>
            ...
            <section>
                <div className="flex gap-6">
                    <div className=" bg-bg-surface rounded-lg border border-default shadow-sm ">
                        <div className="flex  items-center gap-2 p-6 ">
                            <Plus className="h-4 w-4" />
                            <span className="text-main font-semibold text-[20px]">Adicionar Novo Produto</span>
                        </div>
                        <div className="p-6 pt-0 flex flex-col gap-4">
                            <div className="flex flex-col w-full  text-sm">
                                <span className="font-medium text-main">Nome do produto</span>
                                <input type="text" placeholder="Ex: Bolsa Rosa Delicada" className="bg-field rounded-md px-3 py-2" />
                            </div>

                            <div className="flex flex-col w-full  text-sm">
                                <span className="font-medium text-main">Descrição</span>
                                <textarea placeholder="Ex: Descreva o produto" className="bg-field rounded-md px-3 py-2 h-28 resize-y" />
                            </div>

                            <div className="flex flex-col w-full  text-sm">
                                <span className="font-medium text-main">Preço</span>
                                <input type="text" placeholder="Ex: R$150,00" className="bg-field rounded-md px-3 py-2" />
                            </div>
                            ...
                            <div className="flex flex-col w-full text-sm">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <Trash className="h-4 w-4 mt-2 cursor-pointer text-danger" />
                                </div>
                    ...
                    <div className="bg-bg-surface rounded-lg border border-default shadow-sm flex items-start gap-2">
                        <div className="p-6">
                        <span className="text-main font-semibold text-[20px]">Produtos Cadastrados</span>
